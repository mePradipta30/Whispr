...
const SignUpPage = () => {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
        ...
        <div className='w-full max-w-md space-y-8'>
          ...
          <div className='text-center mb-10'>
            <div className='flex flex-col items-center gap-2 group'>
              ...
              <p className='text-orange-700 font-mono text-xl'>Not just chat. It's a <span className='text-emerald-400'>Whispr!</span></p>
            </div>
          </div>
          {/* Form */}
          <form action="#" onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='form-control gap-2'>
              <label htmlFor="label" className='flex items-center border-b-2 border-emerald-700 hover:border-emerald-500 focus:border-rose-400'>
                <h1 className='label-text font-mono text-xl text-emerald-500 inline-block width-[125px] pl-4'>Full Name:</h1>
            ...
            <div className='form-control gap-2'>
              <label htmlFor="label" className='flex items-center border-b-2 border-emerald-700 hover:border-emerald-500'>
                <h1 className='label-text font-mono text-xl text-emerald-500 inline-block width-[125px] pl-10'>Email:</h1>
                <div className='relative input-neutral ml-6'>
                  ...
                  <input
                    type="text"
                    // className={`input input-bordered flex items-center w-full pl-10`}
                    className={`bg-transparent  transition-colors ease-in-out outline-none  text-rose-300 text-xl px-2 py-2 pl-18`}
            ...
            <div className='form-control gap-2 mb-18'>
              <label htmlFor="label" className='flex items-center border-b-2 border-emerald-700 hover:border-emerald-500'>
                <h1 className='label-text font-mono text-xl text-emerald-500 inline-block width-[125px] pl-4'>Password:</h1>
                <div className='relative input-neutral ml-6'>
                  ...
                  <input
                    ...
                    // className={`input input-bordered flex items-center w-full pl-10`}
                    className={`bg-transparent  transition-colors ease-in-out outline-none  text-rose-300 text-xl px-2 py-2 pl-16`}
                    placeholder='**********'
            ...
            <button type='submit' className='py-4 rounded-4xl text-xl leading-none tracking-wide cursor-pointer text-rose-500  bg-emerald-950 hover:bg-emerald-900 hover:text-rose-700 hover:tracking-widest transition-all duration-500 ease-in-out w-full' disabled={isSigningUp}>
              {isSigningUp ? (
                <>
      ...
      {/* RIGHT side */}
      <AuthImagePattern
        title="“Every Chat, a Gentle Whispr.”"
